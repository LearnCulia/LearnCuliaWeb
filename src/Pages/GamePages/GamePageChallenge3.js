...
const GamePageChallenge3 = () => {
  ...
  return (
    <ThemeProvider theme={theme}>
      <div
        className="game3-gamepagechallenge"
        style={
          mode === "dark"
      ...
      {/* Help table modal (auto-shows after 3 wrong attempts) */}
      <Modal open={tableModal} onClose={() => setTableModal(false)}>
        <Box sx={{ ...modalBox, width: "min(780px, 95vw)", maxHeight: "92vh" }}>
          ...
          <Box sx={{ width: "100%", backgroundColor: mode === "dark" ? "#1e1e2a" : "#ffffff", px: 3, py: 3, display: "flex", flexDirection: "column", alignItems: "center", gap: 2, overflowY: "auto" }}>
            <Typography sx={{ color: mode === "dark" ? "#eee" : "#222", textAlign: "center" }}>
              It seems you're struggling with this one. Here's the multiplication table to help!
            </Typography>
            <MultiplicationTable />
        ...
        <Box sx={modalBox}>
          ...
          <Box sx={{ width: "100%", backgroundColor: mode === "dark" ? "#1e1e2a" : "#ffffff", px: 4, py: 3, display: "flex", flexDirection: "column", alignItems: "center", gap: 1.5, textAlign: "center" }}>
            ...
            <Typography sx={{ color: mode === "dark" ? "#aaa" : "#555" }}>
              Now you know how to multiply numbers using the multiplication table!
            </Typography>
...
export default GamePageChallenge3;
