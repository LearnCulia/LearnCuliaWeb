  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <div className="game6-page">
        ...
        <h1>Welcome to Arranging Numbers!</h1>
        <Typography>
          Let's refresh our memory or learn about how to organize and arrange
          numbers!
        </Typography>
        ...
        <Button sx={{ mt: 5, mb: 10 }} onClick={() => setToGamePage6(true)}>
